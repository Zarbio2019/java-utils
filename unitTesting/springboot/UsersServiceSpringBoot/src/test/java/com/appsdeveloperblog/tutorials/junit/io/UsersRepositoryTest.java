...
public class UsersRepositoryTest {
    ...
    /*
    Test for findByEmail() query method.
    ...
    /*
    Test for findByUserId() query method.
    UsersRepository.java
     */
    @Test
    ...
    /*
    Test for findUsersWithEmailEndingWith() PQL Query.
    UsersRepository.java

    test to find all emails that ends with emailDomainName = @gmail.
     */
    @Test
    void testFindUsersWithEmailEndsWith_whenGiveEmailDomain_returnsUsersWithGivenDomain() {
        ...
        String emailDomainName = "@gmail.com"; // my target end email name
