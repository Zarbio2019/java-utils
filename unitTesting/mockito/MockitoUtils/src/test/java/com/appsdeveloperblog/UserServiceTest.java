...
import com.appsdeveloperblog.service.EmailNotificationServiceException;
import com.appsdeveloperblog.service.EmailVerificationServiceImpl;
import com.appsdeveloperblog.service.UserServiceException;
...
public class UserServiceTest {
    ...
    @InjectMocks // inject UsersRepository automatically, create a new instance of its implementation
    ...
    void testCreateUser_whenUserDetailsProvided_returnsUserObject() {
        ...
        //Mockito.verify(usersRepository, Mockito.times(1)) // optional, or
        Mockito.verify(usersRepository)
                .save(any(User.class)); // verify the method inside of mock
        //Mockito.atLeast();
        //Mockito.atMost();
        //Mockito.never();
    }
