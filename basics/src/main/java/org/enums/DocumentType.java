...
public enum DocumentType {
	...
	*/
	...
	// ref: D:\ROMULO\PROJECTS\tech\backend\java\springboot\projects\web\reddit clone\backend\spring-reddit-clone-master\src\main\java\com\programming\techie\springredditclone\model\VoteType.java
	...
	public static void main(String[] args) {
		...
		try {
			...
			/* ref:
			POMCR001Impl.java, PHIAR003Impl.java
			dto_proposals, DocumentType.java
			 */
		} catch (Exception e) {
