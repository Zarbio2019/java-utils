...
public class FtpUtil
{
   ...
   {
	   try {
		   FtpUtil ftpobj = new FtpUtil("sftp://test.rebex.net/", 2121, "demo", "password");
           //ftpobj.uploadFTPFile("C:\\Users\\shruti\\Shruti.txt", "Shruti.txt", "/");
           ftpobj.downloadFTPFile("readme.txt", "/");
   ...
   public boolean listFTPFiles(String directory, String fileName) throws IOException {
       ...
       for (FTPFile file : files) {
           ...
           if(details.equals(fileName))
           {
               ...
               System.out.println("Verification Failed: The filename is not updated at the CDN end.");
